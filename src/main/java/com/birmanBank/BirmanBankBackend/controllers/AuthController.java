...
public class AuthController {
    ...
    public Map<String, String> register(@RequestBody Map<String, Object> requestBody) {
        ...
        //extract the password from the request body to be used for the User password (in User model)
        ...
        Client client = Client.builder()
                ...
                .userCardNumber(cardNumber) //link the Users table's cardNumber to the Clients table so its like a foreign key
    ...
    private String generateClientId() {
        return "CLIENT-" + System.currentTimeMillis(); // Example: CLIENT-1672538493021
    }
}